...
function preload(){
  ...
  treasure1Img = loadImage("images/treasure (1).png")
  treasure2Img = loadImage("images/treasure (2).png")
  treasure3Img = loadImage("images/treasure (3).png")
  treasure4Img = loadImage("images/treasure (4).png")
...
treasure1 = createSprite(850,260,10,10);
treasure1.addImage(treasure1Img);
treasure1Img.scale = 0.1;

treasure2 = createSprite(45,520,10,10);
treasure2.addImage(treasure2Img);
treasure2Img.scale = 0.1;

treasure3 = createSprite(550,250,10,10);
treasure3.addImage(treasure3Img);
treasure3Img.scale = 0.1;

treasure4 = createSprite(1050,200,10,10);
treasure4.addImage(treasure4Img);
treasure4Img.scale = 0.1;
...
drawSprites();
if(player.isTouching(monstergroup)||player.isTouching(alleingroup)){
  player.destroy();
  textSize(40);
  fill("Orange");
  text("U NOOB LOOSE",625,350);
}
